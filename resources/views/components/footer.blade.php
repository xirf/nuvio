<footer class="grid grid-cols-12 gap-10 p-32 max-w-7xl m-auto text-sm pb-5">
	<div class="col-span-3">
		<h1 class="text-3xl font-bold">Nuvio<span class="text-red-500">.</span></h1>
	</div>
	<div class="col-span-3 flex flex-col gap-2">
		<h1 class="text-lg font-bold">Tentang kami</h1>
	...
	<div class="col-span-3 flex flex-col gap-3">
		<h1 class="text-lg font-bold">Butuh Bantuan?</h1>
		<ul class="flex flex-col gap-2 submenu">
			<li>
	...
	<div class="col-span-3 flex flex-col gap-3">
		...
		<div class="flex flex-col gap-2">
			<button class="btn text-white btn-sm text-xss flex-grow-0 w-fit bg-red-500 hover:bg-red-400">
			...
			<div class="text-gray-400 font-medium text-xss">
