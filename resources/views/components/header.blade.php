        ...
        <header class="sticky top-0 left-0 w-full px-14 flex justify-center transition-all duration-1000 z-[999]">
            <div class="navbar max-w-4xl ">
                ...
                <div class="flex items-center justify-center navbar-center flex-grow">
                    <div class="flex font-medium text-xs relative">
                        @foreach ($menu as $index => $item)
                            <div class="w-16 2xl:w-28 text-center smooth-transition hover:text-red-500 {{ strtolower($active) == strtolower($item['name']) ? 'text-red-500' : '' }}"
                                id="menuItems"
                ...
                <div class='grid gap-5 grid-cols-3'>
                    <a href='/cart'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-4 2xl:w-6 w-4 2xl:h-6">
                            <path
